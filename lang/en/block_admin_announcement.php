...
$string['settingenabled_label'] = 'Enable admin announcement';
$string['settingenabled_description'] = 'Show side wide admin announcement';
$string['settingtext_label'] = 'Admin announcement text';
